...
public class PalindromeLinkedList {
	public boolean isPalindrome(ListNode head) {
		...
		// Traverse to mid node and Reverse the First half of the LinkedList in
		// the same run
		...
		// At the end of the previous loop, SecondHalfStart pointer is still
		// stuck on the end of the first half
